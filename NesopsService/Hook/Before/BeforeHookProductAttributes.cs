...
{
    public class BeforeHookProductAttributes : HookHandleBase<ProductdevContext, ProductAttributes, ProductAttributesCreateModel, ProductAttributesRequestModel>
    {
